...
## Project Structure
    ...
    ├── testapiautosetting_125097  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125097`
...
2. Clone this repo and `cd testapiautosetting_125097`
